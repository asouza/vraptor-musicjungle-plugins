...
/**
 * The resource <code>UsersController</code> handles all user operations, such
 * as adding new users, listing users, and so on.
 */
@Controller
public class UsersController {
	 ...
	 *            dao factory.
	 * @param userInfo
	 *            info on the logged user.
	 * @param result
	 *            VRaptor result handler.
	 * @param validator
	 *            VRaptor validator.
	 */
	@Inject
	 ...
	 * 
	 * URL: /home View: /WEB-INF/jsp/user/home.jsp
	 * 
	...
	public void home(Page page) {
		Paginator<Music> paginator = query
				...
				.setParameter("user", userInfo.getUser()).paginate(page);
	 ...
	 * Accepts HTTP GET requests.
	 * 
	 * URL: /users (only GET requests for this URL) View:
	 ...
	 * Accepts HTTP GET requests.
	 * 
	 * URL: /users/{login} (for example, /users/john shows information of the
	 * user with login john) View: /WEB-INF/jsp/user/view.jsp
	 * 
