...
public class MusicController {
	...
	@Path("/musics")
	@Post
	public void add(final @NotNull @Valid Music music, UploadedFile file, @Resize(width=50, height=50) UploadedImage cover) {
		validator.onErrorForwardTo(UsersController.class).home(new Page());
		...
		if(cover!=null){
			cover.save("covers/cover_"+music.getId()+"."+cover.extension());
		}
